...
class Calculadora {
    ...
    realizarCalculo(){
        let resultado;
        let conversionValorSuperior = parseFloat(this.valorSuperior)//convertimos los numeros que vienen como string en numeros para que puedan ser interpretados por js
        let conversionValorInferior = parseFloat(this.valorInferior)//convertimos los numeros que vienen como string en numeros para que puedan ser interpretados por js
